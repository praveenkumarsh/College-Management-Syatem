...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2019 at 05:23 PM
...
CREATE TABLE `attendance` (
  `day` int(20) NOT NULL,
  `2k18/co/321` int(1) NOT NULL DEFAULT '0'
...
INSERT INTO `attendance` (`day`, `2k18/co/321`) VALUES
(1, 1);
...
CREATE TABLE `sub1` (
  `day` int(20) NOT NULL,
  `2k18/co/212` int(1) NOT NULL DEFAULT '0',
  `2k18/co/321` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
INSERT INTO `sub1` (`day`, `2k18/co/212`, `2k18/co/321`) VALUES
(1, 0, 1);
...
INSERT INTO `sub2` (`day`, `2k18/co/212`, `2k18/co/321`) VALUES
(1, 0, 1);
...
INSERT INTO `sub3` (`day`, `2k18/co/212`, `2k18/co/321`) VALUES
(1, 0, 1);
...
INSERT INTO `sub4` (`day`, `2k18/co/212`, `2k18/co/321`) VALUES
(1, 0, 1);
...
INSERT INTO `sub5` (`day`, `2k18/co/212`, `2k18/co/321`) VALUES
(1, 0, 1);
...
INSERT INTO `sub6` (`day`, `2k18/co/212`, `2k18/co/321`) VALUES
(1, 0, 1);
