 ...
 */
package admin_portal.ui.home.updateteacherpass;

import admin_portal.database_connection.DaoTeacher;
 ...
 * @author Praveen
 */
public class UpteachpassController implements Initializable {
    ...
    private void handleupdate(ActionEvent event) {
        ...
        if(!pass.equals(repass)){
            ...
            if(DaoTeacher.checkData(userid)){
                int check = DaoTeacher.update(userid, pass);
                if(check==1){
