...
public class DaoTeacher {
    ...
    public static int save(String name, String password, String email){
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("insert into teacher(name,password,email) values(?,?,?)");
            ps.setString(1, name);
    ...
    public static boolean validate(String name, String password) {
        ...
        try {
            Connection con = DB.getConnection();
            PreparedStatement ps = con.prepareStatement("select * from teacher where tusername=? and tpassword=?");
            ps.setString(1, name);      
            ps.setString(2, password);
